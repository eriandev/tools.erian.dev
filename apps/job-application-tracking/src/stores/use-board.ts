...
import { boardInfo, isLoading, boardCount, BOARD_INFO_KEY, DEFAULT_BOARD_INFO } from './consts'
import type { BoardInfo, JobApplicationInfo, JobApplicationStatus } from './types'
